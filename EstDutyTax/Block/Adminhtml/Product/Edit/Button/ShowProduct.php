...
/**
 * Class ShowProduct
 * Adds a custom button to the product edit page in the admin panel.
 */
class ShowProduct extends Generic
{
    /**
     * @var Registry
     */
    ...
    public function getButtonData()
    {
        ...
        $url = $this->getUrl('EstDutyTax/showproduct', ['id' => $productId]);
    ...
    /**
     * Get product ID from the registry.
     *
     * @return int|null
     */
